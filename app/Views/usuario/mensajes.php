...
<head>
    ...
    <title><?=$sistema_nombre;?> :: v<?=$sistema_version;?> :: <?=$sistema_cliente;?></title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="text-center">
                                        <p class="mb-0">¿Olvido su contraseña? <a href="javascript:void(0);" class="text-warning">Clic aqui para recuperarla</a></p>
                                    </div>
                                </div>
